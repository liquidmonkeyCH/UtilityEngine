...
bool io_service_iface::process_recv(session_iface* session, net_size_t size){ return session->process_recv(size); }
bool io_service_iface::process_send(session_iface* session, net_size_t size){ return session->process_send(size); }
// responder_iface
