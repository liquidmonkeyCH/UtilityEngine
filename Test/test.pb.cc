...
static void InitDefaultsscc_info_test_test_2eproto() {
  ...
  {
    void* ptr = &::haha::_test_default_instance_;
    new (ptr) ::haha::test();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::haha::test::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::haha::test, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::haha::test, id_),
  PROTOBUF_FIELD_OFFSET(::haha::test, num_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::haha::test)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::haha::_test_default_instance_),
};

const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\ntest.proto\022\004haha\"#\n\004test\022\n\n\002id\030\001 \001(\r\022\017"
  "\n\003num\030\002 \003(\rB\002\020\001b\006proto3"
  ;
...
test::test()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:haha.test)
}
test::test(const test& from)
  ...
  id_ = from.id_;
  // @@protoc_insertion_point(copy_constructor:haha.test)
}
...
test::~test() {
  // @@protoc_insertion_point(destructor:haha.test)
  SharedDtor();
}
...
void test::Clear() {
// @@protoc_insertion_point(message_clear_start:haha.test)
...
::PROTOBUF_NAMESPACE_ID::uint8* test::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:haha.test)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:haha.test)
  return target;
}

size_t test::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:haha.test)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:haha.test)
  GOOGLE_DCHECK_NE(&from, this);
  const test* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<test>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:haha.test)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:haha.test)
    MergeFrom(*source);
  }
}

void test::MergeFrom(const test& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:haha.test)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:haha.test)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:haha.test)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::haha::test* Arena::CreateMaybeMessage< ::haha::test >(Arena* arena) {
  return Arena::CreateInternal< ::haha::test >(arena);
}
